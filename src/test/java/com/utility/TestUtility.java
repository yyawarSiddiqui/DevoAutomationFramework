...
public class TestUtility {
	...
	public static CreateJobPOJO getCreateJobJsonData() {
		...
		String imei=faker.numerify("32########");

		CustomerPOJO customerPOJO = new CustomerPOJO(fname, lastname, phoneNumber, altPhonenumber, email,
				email);
		...
		CreateJobPOJO createJobPOJO = new CreateJobPOJO(0, 2, 1, 2, customerPOJO, customerAddress, customer_productPOJO,
				problemsPOJO);
