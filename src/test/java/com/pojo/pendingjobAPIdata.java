...
public class pendingjobAPIdata {
	...
	public pendingjobAPIdata(int id, String job_number, int tr_customer_id, int tr_customer_product_id,
			...
			String assigned_by, String assigned_on, String assigned_to, String mst_warrenty_status_code) {
		super();
		this.id = id;
	...
	public String toString() {
		return "pendingjobAPIdata [id=" + id + ", job_number=" + job_number + ", tr_customer_id=" + tr_customer_id
