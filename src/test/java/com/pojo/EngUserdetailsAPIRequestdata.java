...
public class EngUserdetailsAPIRequestdata {
	...
	public EngUserdetailsAPIRequestdata(int id, String first_name, String last_name, String login_id,
			String mobile_number, String email_id, String password, String reset_password_date, int lock_status,
			int is_active, int mst_role_id, int mst_service_location_id, String created_at, String modified_at,
	...
	public String toString() {
		return "EngUserdetailsAPIRequestdata [id=" + id + ", first_name=" + first_name + ", last_name=" + last_name
