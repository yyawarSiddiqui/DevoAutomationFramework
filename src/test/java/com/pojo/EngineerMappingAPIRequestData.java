...
public class EngineerMappingAPIRequestData {
	...
	public EngineerMappingAPIRequestData(int id, String first_name, String last_name, String login_id,
			String mobile_number, String email_id, String password, String reset_password_date, int lock_status,
			boolean is_active, int mst_role_id, int mst_service_location_id, String created_at, String modified_at,
			String role_name, String service_location) {
		super();
		this.id = id;
	...
	public String toString() {
		return "EngineerMappingAPIRequestData [id=" + id + ", first_name=" + first_name + ", last_name=" + last_name
